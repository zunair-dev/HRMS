...
class SalariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create salary" do
    assert_difference("Salary.count") do
      post salaries_url, params: { salary: { amount: @salary.amount, effective_date: @salary.effective_date, employee_id: @salary.employee_id, frequency: @salary.frequency } }
    end
  ...
  test "should update salary" do
    patch salary_url(@salary), params: { salary: { amount: @salary.amount, effective_date: @salary.effective_date, employee_id: @salary.employee_id, frequency: @salary.frequency } }
